...
router = APIRouter(
    prefix="/posts",
    tags=["Posts"] # For fast api auto docs
)
...
def create_posts(post: schemas.PostCreate, db: Session = Depends(get_db), 
    ...
    new_post = models.Post(owner_id=current_user.id, **post.dict()) # Unpacking dict. It can now work on any num of fields.
    db.add(new_post)
    db.commit()
    db.refresh(new_post) # Retrieve the value from database and store it in new_post.
